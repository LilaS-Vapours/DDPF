...
python -m torch.distributed.launch \
    ...
    --node_rank=0 \
    --master_port=${tport} \
    $ROOT/train_semi_experiment.py \
    --config=/media/ubuntu/7C4C5D504C5D0674/pengyang/code/AugSeg-main/exps/zrun_vocs/r101_voc_1323_experiment/config_semi.yaml --seed 2 --port ${tport}
